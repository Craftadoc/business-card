...
\begin{document}
  ...
  \begin{tikzpicture}[remember picture,overlay,inner sep=0pt]
    ...
    %<{description: "Back text lines", type: "list", minChildren: 1, maxChildren: 3}
        ...
        %>
    %>
    %<{type: "list", description: "Slogan lines"}
        %<{description: "Slogan line", type: "text", maxLength: 19, escapeLatex: false, inputValue: "You do,"}
            \sloganLine{You do,}; \\
        %>
        %<{description: "Slogan line", type: "text", maxLength: 19, escapeLatex: false, inputValue: "we Doe"}
            \sloganLine{we Doe}; \\
        %>
    %>
    };
